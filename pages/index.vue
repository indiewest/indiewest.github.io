<template>
    <div class="px-[24px] lg:px-[40px]">
        <div class="text-blue text-[90px] leading-none">
            THERE IS<br/>
            NO BETTER PARTNER.<br/>
            BECAUSE WE’RE HERE.
        </div>
        <ul class="grid grid-cols-1 gap-x-[40px] gap-y-[80px] mt-[44px]">
            <li class="work-item">
        ...
        <!-- <img src="/images/main-logo.svg" class="w-[80vw] lg:w-[600px]"/> -->
    </div>
</template>